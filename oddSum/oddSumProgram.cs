...
namespace oddSum
{
    class oddSumProgram
    {
        ...
        //    Console.Write("\n");
        //    bool isInt = int.TryParse(Console.ReadLine(), out enteredNum);
        //    if (!isInt || enteredNum < 0)
        //    {
        //        Console.Write("\nВведите целое положительное либо 0:");
        //        return getNumAndAddToList(nums);
        //    }
